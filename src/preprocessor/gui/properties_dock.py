...
class Ui_PropertiesDock(object):
    def setupUi(self, PropertiesDock):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 460, 662))
    ...
    def retranslateUi(self, PropertiesDock):
        ...
        self.comboboxThresholdingMethod.setItemText(2, QCoreApplication.translate("PropertiesDock", u"BinaryINV", None))
        self.comboboxThresholdingMethod.setItemText(3, QCoreApplication.translate("PropertiesDock", u"Trunc", None))
        self.comboboxThresholdingMethod.setItemText(4, QCoreApplication.translate("PropertiesDock", u"ToZero", None))
        self.comboboxThresholdingMethod.setItemText(5, QCoreApplication.translate("PropertiesDock", u"ToZeroINV", None))
