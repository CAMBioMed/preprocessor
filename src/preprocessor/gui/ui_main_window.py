...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuFile_OpenProject = QAction(MainWindow)
        ...
        self.menuFile_NewProject = QAction(MainWindow)
        ...
        self.menuFile_SaveProject = QAction(MainWindow)
        ...
        self.menuFile_SaveProjectAs = QAction(MainWindow)
        ...
        self.menuFile_CloseProject = QAction(MainWindow)
        ...
        self.menuWindow_ShowEditorPanel = QAction(MainWindow)
        self.menuWindow_ShowEditorPanel.setObjectName(u"menuWindow_ShowEditorPanel")
        self.menuFile_ProjectSettings = QAction(MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        self.menuFile_OpenProject.setText(QCoreApplication.translate("MainWindow", u"&Open Project...", None))
#if QT_CONFIG(statustip)
        self.menuFile_OpenProject.setStatusTip(QCoreApplication.translate("MainWindow", u"Open an existing project.", None))
#endif // QT_CONFIG(statustip)
        self.menuFile_Exit.setText(QCoreApplication.translate("MainWindow", u"E&xit", None))
#if QT_CONFIG(statustip)
        self.menuFile_Exit.setStatusTip(QCoreApplication.translate("MainWindow", u"Exit the application.", None))
#endif // QT_CONFIG(statustip)
        self.menuHelp_About.setText(QCoreApplication.translate("MainWindow", u"&About...", None))
#if QT_CONFIG(statustip)
        self.menuHelp_About.setStatusTip(QCoreApplication.translate("MainWindow", u"About this application.", None))
#endif // QT_CONFIG(statustip)
        self.menuFile_NewProject.setText(QCoreApplication.translate("MainWindow", u"&New Project...", None))
#if QT_CONFIG(statustip)
        self.menuFile_NewProject.setStatusTip(QCoreApplication.translate("MainWindow", u"Create a new project.", None))
#endif // QT_CONFIG(statustip)
        self.menuFile_SaveProject.setText(QCoreApplication.translate("MainWindow", u"&Save Project", None))
#if QT_CONFIG(statustip)
        self.menuFile_SaveProject.setStatusTip(QCoreApplication.translate("MainWindow", u"Save the current project.", None))
#endif // QT_CONFIG(statustip)
        self.menuFile_SaveProjectAs.setText(QCoreApplication.translate("MainWindow", u"Save Project &As...", None))
#if QT_CONFIG(statustip)
        self.menuFile_SaveProjectAs.setStatusTip(QCoreApplication.translate("MainWindow", u"Save the current project under a new name.", None))
#endif // QT_CONFIG(statustip)
        self.menuFile_CloseProject.setText(QCoreApplication.translate("MainWindow", u"&Close Project", None))
#if QT_CONFIG(statustip)
        self.menuFile_CloseProject.setStatusTip(QCoreApplication.translate("MainWindow", u"Close the current project.", None))
#endif // QT_CONFIG(statustip)
        self.menuFile_ExportAll.setText(QCoreApplication.translate("MainWindow", u"E&xport All...", None))
        self.menuEdit_DetectQuadrat.setText(QCoreApplication.translate("MainWindow", u"Detect &quadrat", None))
        self.menuWindow_ShowThumbnailsPanel.setText(QCoreApplication.translate("MainWindow", u"Thumbnails panel", None))
        self.menuWindow_ShowEditorPanel.setText(QCoreApplication.translate("MainWindow", u"Editor panel", None))
        self.menuFile_ProjectSettings.setText(QCoreApplication.translate("MainWindow", u"Project Se&ttings...", None))
